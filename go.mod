...
require (
	...
	github.com/cloud-portable/s3tests/packages/go v0.0.0-20260907115622-eed8ba8e962e
...
require (
	...
	github.com/cloud-portable/s3vectors/packages/go v1.0.1-0.20260907115341-668326c34057 // indirect
